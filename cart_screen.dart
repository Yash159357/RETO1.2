...
//
//     final cartData = ref.watch(cartProvider); //This will watch our data and will do the changes like we are adding product or removing product.
//
...
//       ), //End of APP BAR
//
//       body: cartData.isEmpty ? Center( //If our CART is EMPTY then run this Center Widget
//         child: Column(
//           mainAxisAlignment: MainAxisAlignment.center, //Taking the below Text to the Center of the Screen vertically.
//           children: [
//             Text(
//               'Your Shopping CART is Empty \n You can add Product to Your CART by \n clicking the Button Below!', //'\n' takes us to next line.
//               textAlign: TextAlign.center, //This will align our above text to center horizontally
...
//             TextButton(
//                 onPressed: () {
//                   Navigator.push(context, MaterialPageRoute(builder: (context) { //Navigating the user to Home Screen if he/she press this button
//                     return MainScreen();
//                   }));
//                 },
//
...
//       //     }
//       // ),
//       : SingleChildScrollView( //If the CART is NOT EMPTY then run this Widget
//         child: Column(
...
//                       left: 69,
//                       top: 14,
//                       child: Text('Number of Item(s) in Cart: ${cartData.length}',
//                         style: GoogleFonts.lato(
//                           fontSize: 16,
//                           // letterSpacing: 1,
//                           color: Colors.black,
...
//                 physics: const ScrollPhysics(),
//                 itemBuilder: (context, index) {
//                   final cartItem = cartData.values.toList()[index]; //Accessing details of every added item in Cart.
//
//                   return Padding(padding: EdgeInsets.all(8),
//                       child: Card(
//                         child: SizedBox(
//                           height: 200, //Height of the box inside which we will show the details of the item added.
//
//                           child: Row(
//                             mainAxisAlignment: MainAxisAlignment.start,
//                             children: [
...
//                               SizedBox(
//                                 height: 150, //Height and Width of the box inside which our image will be displayed but as our image will take up the entire box so changing these dimensions will change the height and width of our image as well.
//                                 width: 100,
//                                 child: Image.network(
//                                   cartItem.imageUrl[0], //As a single product may have multiple images but we want to display only the first image so we are mentioning '[0]'.
//                                   fit: BoxFit.cover,
//                                 ),
//                               ),
//
...
//                                 child: Column(
//                                   mainAxisAlignment: MainAxisAlignment.spaceEvenly, //To have equal spacing vertically among all our widgets.
...
//                                     Text('\₹${cartItem.discount.toStringAsFixed(2)}',
//                                       style: GoogleFonts.lato(
//                                         fontSize: 16,
//                                         // letterSpacing: 1,
//                                         color: Colors.pink,
...
//                                               IconButton(
//                                                   onPressed: () {
//                                                     _cartProvider.decrementItem(cartItem.productId); //Decrementing the product quantity by calling the 'decrementItem()' function present in 'cart_provider' page.
//                                                   },
//
//                                                   icon: Icon(
...
//                                               IconButton(
//                                                 onPressed: () {
//                                                   _cartProvider.incrementItem(cartItem.productId); //Incrementing the product quantity by calling the 'incrementItem()' function present in 'cart_provider' page.
//                                                 },
//
//                                                 icon: Icon(
//                                                   CupertinoIcons.plus,
...
//                                         IconButton(
//                                           onPressed: () {
//                                             _cartProvider.removeItem(cartItem.productId); //Removing the product by calling the 'removeItem()' function present in 'cart_provider' page.
//                                           },
//
//                                           icon: Icon(
...
//         height: 89,
//         clipBehavior: Clip.hardEdge,
//         decoration: const BoxDecoration(), //Whenever we are using Container Widget always write BoxDecoration even when we are not using it else it will ask us to use SizedBox and may affect the performance of the App.
//         child: Stack(
//           clipBehavior: Clip.none,
//           children: [
//             Align(
...
//                     color: totalAmount == 0.0?Colors.grey : Colors.green, //If our Total Amount is 0 that means no product is added and our Button Color will be grey and if our Total Amount is not zero it means there is some product in our Cart and our Button Color will change to green.
//                   ),
//
//                   child: Center(
//                     child: Row(
                                          ...
                                          Padding(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: Image.network(
                                                  cartItem
                                                      .imageUrl[0], //As a single product may have multiple images but we want to display only the first image so we are mentioning '[0]'.
                                                  fit: BoxFit.cover,
                                                ),
                                              ),
                                            ),
                          ...
                          ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return CheckoutScreen(totalPrice: totalAmount,);
                                  },
                                ),
                              );
                            },
